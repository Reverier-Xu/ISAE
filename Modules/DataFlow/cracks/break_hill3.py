...
mono = ngram_score('Modules/DataFlow/cracks/monograms.txt')
bi = ngram_score('Modules/DataFlow/cracks/bigrams.txt')
quad = ngram_score('Modules/DataFlow/cracks/quadgrams.txt')
