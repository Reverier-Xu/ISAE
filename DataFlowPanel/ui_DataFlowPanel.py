...
class ui_CryptoPanel(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.widget = QtWidgets.QWidget(self.CryptoMainSpliter, flags=Qt.WindowFlags())
        ...
        self.horizontalLayout_2.addWidget(self.CryptoMainSpliter, alignment=Qt.Alignment())
