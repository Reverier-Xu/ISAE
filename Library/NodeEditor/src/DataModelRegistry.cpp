...
std::unique_ptr<NodeDataModel> DataModelRegistry::create(
...
TypeConverter DataModelRegistry::getTypeConverter(
    NodeDataType const &d1, NodeDataType const &d2) const {
