...
bool DockWidgetTabPrivate::startFloating(eDragState DraggingState) {
    ...
    ADS_PRINT("widgetCount "
              << DockWidget->dockAreaWidget()->dockWidgetsCount());
...
void CDockWidgetTab::mouseMoveEvent(QMouseEvent* ev) {
    ...
    bool MouseOutsideBar =
        (MappedPos.x() < 0) || (MappedPos.x() > parentWidget()->rect().right());
    // Maybe a fixed drag distance is better here ?
    int DragDistanceY =
        qAbs(d->GlobalDragStartMousePosition.y() - ev->globalPos().y());
    if (DragDistanceY >= CDockManager::startDragDistance() || MouseOutsideBar) {
        ...
        if (Features.testFlag(CDockWidget::DockWidgetFloatable) ||
            ...
            // tab because it looks strange if it remains on its dragged
            // position
            if (d->isDraggingState(DraggingTab) &&
                !CDockManager::configFlags().testFlag(
        ...
        return;
               ...
               (ev->globalPos() - d->GlobalDragStartMousePosition)
                       .manhattanLength() >=
...
//============================================================================
bool CDockWidgetTab::isActiveTab() const { return d->IsActiveTab; }
...
void CDockWidgetTab::setActiveTab(bool active) {
    ...
    bool TabHasCloseButton =
        (ActiveTabHasCloseButton && active) | AllTabsHaveCloseButton;
...
//============================================================================
CDockWidget* CDockWidgetTab::dockWidget() const { return d->DockWidget; }
...
//============================================================================
CDockAreaWidget* CDockWidgetTab::dockAreaWidget() const { return d->DockArea; }
...
void CDockWidgetTab::setIcon(const QIcon& Icon) {
    ...
    d->Icon = Icon;
    if (d->IconLabel) {
        d->IconLabel->setPixmap(Icon.pixmap(
...
//============================================================================
const QIcon& CDockWidgetTab::icon() const { return d->Icon; }

//============================================================================
QString CDockWidgetTab::text() const { return d->TitleLabel->text(); }
...
//============================================================================
bool CDockWidgetTab::isTitleElided() const { return d->TitleLabel->isElided(); }
