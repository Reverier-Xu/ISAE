...
void FloatingDragPreviewPrivate::updateDropOverlays(const QPoint& GlobalPos) {
    ...
    if (!TopContainer) {
        ...
        if (CDockManager::configFlags().testFlag(
...
void FloatingDragPreviewPrivate::createFloatingWidget() {
    ...
    } else if (DockArea && DockArea->features().testFlag(
...
CFloatingDragPreview::CFloatingDragPreview(QWidget* Content, QWidget* parent)
    ...
    // operations
    if (CDockManager::configFlags().testFlag(
            CDockManager::DragPreviewShowsContentPixmap)) {
...
//============================================================================
CFloatingDragPreview::~CFloatingDragPreview() { delete d; }
...
void CFloatingDragPreview::finishDragging() {
    ...
    auto DockDropArea =
        d->DockManager->dockAreaOverlay()->visibleDropAreaUnderCursor();
    auto ContainerDropArea =
        d->DockManager->containerOverlay()->visibleDropAreaUnderCursor();
    if (!d->DropContainer) {
...
//============================================================================
void CFloatingDragPreview::onApplicationStateChanged(
