...
//============================================================================
CElidingLabel::~CElidingLabel() { delete d; }

//============================================================================
Qt::TextElideMode CElidingLabel::elideMode() const { return d->ElideMode; }
...
//============================================================================
bool CElidingLabel::isElided() const { return d->IsElided; }
...
QSize CElidingLabel::minimumSizeHint() const {
    if (!this->pixmap(Qt::ReturnByValue).isNull() || d->isModeElideNone()) {
...
//============================================================================
QString CElidingLabel::text() const { return d->Text; }
}  // namespace ads
