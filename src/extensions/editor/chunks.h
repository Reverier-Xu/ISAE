...
/*! The Chunks class is the storage backend for HexEditor.
 *
 * When HexEditor loads data, Chunks access them using a QIODevice interface. When the app uses
