...
\endrst */
    template<typename T>
    T reinterpret_borrow(handle h) { return {h, object::borrowed_t {}}; }
...
\endrst */
    template<typename T>
    T reinterpret_steal(handle h) { return {h, object::stolen_t {}}; }
...
\endrst */
    ...
    template<>
    inline bool isinstance<object>(handle obj) { return obj.ptr() != nullptr; }
...
// Match a PyObject*, which we want to convert directly to handle via its converting constructor
        ...
        public:
            ...
            template<typename T>
            T cast() const { return get_cache().template cast<T>(); }
...
// unsigned type: (A)-1 != (B)-1 when A and B are unsigned types of different sizes).
    ...
    PYBIND11_OBJECT_DEFAULT(capsule, object, PyCapsule_CheckExact)
        ...
        capsule(PyObject *ptr, bool is_borrowed) : object(
                is_borrowed ? object(ptr, borrowed_t {}) : object(ptr, stolen_t {})) { }
...
/// @} python_builtins
    ...
    PYBIND11_NAMESPACE_BEGIN(detail)
        template<typename D>
        iterator object_api<D>::begin() const { return iter(derived()); }

        template<typename D>
        iterator object_api<D>::end() const { return iterator::sentinel(); }
