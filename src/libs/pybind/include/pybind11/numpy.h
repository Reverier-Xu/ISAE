...
PYBIND11_NAMESPACE_BEGIN(PYBIND11_NAMESPACE)
    ...
    PYBIND11_NAMESPACE_BEGIN(detail)
        ...
        constexpr int platform_lookup() { return -1; }
 ...
 */
        ...
        public:
            ...
            template<typename... Ix>
            const T *data(Ix... ix) const { return &operator()(ssize_t(ix)...); }
        ...
        public:
            ...
            template<typename... Ix>
            T *mutable_data(Ix... ix) { return &operator()(ssize_t(ix)...); }
        };
    ...
    struct format_descriptor<T, detail::enable_if_t<detail::array_info<T>::is_array>> {
        static std::string format() {
            ...
            return extents.text + format_descriptor<remove_all_extents_t < T>>
            ::format();
        }
    };
...
#define PYBIND11_NUMPY_DTYPE_EX(Type, ...) \
    ::pybind11::detail::npy_format_descriptor<Type>::register_dtype \
        ...
        enum class broadcast_trivial {
            non_trivial, c_trivial, f_trivial
        };
...
// Vectorize a class method (non-const):
    template<typename Return, typename Class, typename... Args,
            typename Helper = detail::vectorize_helper<decltype(std::mem_fn(
                    std::declval<Return (Class::*)(Args...)>())), Return, Class *, Args...>>
...
// Vectorize a class method (const):
    template<typename Return, typename Class, typename... Args,
            typename Helper = detail::vectorize_helper<decltype(std::mem_fn(
                    std::declval<Return (Class::*)(Args...) const>())), Return, const Class *, Args...>>
