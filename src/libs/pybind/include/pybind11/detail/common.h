...
/// Compile-time integer sum
        ...
        constexpr size_t constexpr_sum(Ts... ns) { return (0 + ... + size_t {ns}); }
...
// arithmetic type (if T is arithmetic), or explicitly constructible from an iterator pair.
        ...
        public:
            ...
            template<typename Container, typename = enable_if_t<std::is_convertible<decltype(*std::begin(
                    std::declval<const Container &>())), T>::value>>
