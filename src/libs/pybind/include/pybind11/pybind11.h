...
#  pragma GCC diagnostic pop
...

            {
                ...
                static_assert(has_arg_annotations || !has_kwonly_args,
...
/// Forward everything else unchanged.
    ...
    PYBIND11_OBJECT(class_, generic_type, PyType_Check)
        ...
        template<typename... Extra>
        class_ &
        def_property(const char *name, const cpp_function &fget, const cpp_function &fset, const Extra &...extra) {
        ...
        template<typename Getter, typename... Extra>
        class_ &
        def_property_static(const char *name, const Getter &fget, const cpp_function &fset, const Extra &...extra) {
    ...
    private:
        ...
        static void init_holder_from_existing(const detail::value_and_holder &v_h,
            ...
            new(std::addressof(v_h.holder<holder_type>())) holder_type(
                    *reinterpret_cast<const holder_type *>(holder_ptr));
        }
...
/// Binds an existing constructor taking arguments Args...
    ...
    detail::initimpl::constructor<Args...> init() { return {}; }

/// Like `init<Args...>()`, but the instance is always constructed through the alias class (even
/// when not inheriting on the Python side).
    template<typename... Args>
    detail::initimpl::alias_constructor<Args...> init_alias() { return {}; }
