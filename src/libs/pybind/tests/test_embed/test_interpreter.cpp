...
REQUIRE(py::module::import("widget_module")
.attr("add")(1, 2).
...
REQUIRE(py::module::import("external_module")
.attr("A")(123).attr("value").
...
<uintptr_t> (*py::detail::get_internals_pp())

==
py::module::import("external_module").attr("internals_at")().
