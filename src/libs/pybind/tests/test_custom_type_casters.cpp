...
namespace pybind11 {
    namespace detail {
        ...
        public:
            PYBIND11_TYPE_CASTER(ArgInspector1, _(
            "ArgInspector1"));
        ...
        public:
            PYBIND11_TYPE_CASTER(ArgInspector2, _(
            "ArgInspector2"));
        ...
        public:
            PYBIND11_TYPE_CASTER(ArgAlwaysConverts, _(
            "ArgAlwaysConverts"));
...
namespace pybind11 {
    namespace detail {
        ...
        struct type_caster<DestructionTester> {
            PYBIND11_TYPE_CASTER(DestructionTester, _(
            "DestructionTester"));
