...
doc() = "pybind11 cross-module test module";
...
// test_load_external
bind_local<ExternalType1>(m,
"ExternalType1",

py::module_local()

);
bind_local<ExternalType2>(m,
"ExternalType2",
...
bind_local<NonLocalType, 0>(m,
"NonLocalType");
});

// test_stl_bind_local
// stl_bind.h binders defaults to py::module_local if the types are local or converting:
py::bind_vector<LocalVec>(m,
"LocalVec");
py::bind_map<LocalMap>(m,
"LocalMap");
...
py::bind_vector<NonLocalVec>(m,
"NonLocalVec");
});
m.def("register_nonlocal_map", [m]() {
py::bind_map<NonLocalMap>(m,
"NonLocalMap");
});
// The default can, however, be overridden to global using `py::module_local()` or
// `py::module_local(false)`.
// Explicitly made local:
py::bind_vector<NonLocalVec2>(m,
"NonLocalVec2",
...
py::bind_map<NonLocalMap2>(m,
"NonLocalMap2", py::module_local(false));
});
...
bind_local<MixedGlobalLocal, 200>(m,
"MixedGlobalLocal",
...
bind_local<MixedLocalGlobal, 2000>(m,
"MixedLocalGlobal", py::module_local(false));
});
m.def("get_mixed_gl", [](
int i
) {
...
py::detail::registered_local_types_cpp();

});

// test_stl_caster_vs_stl_bind
py::bind_vector<std::vector<int>>(m,
"VectorInt");
...
py::bind_vector<std::vector<bool>>(m,
"VectorBool");
