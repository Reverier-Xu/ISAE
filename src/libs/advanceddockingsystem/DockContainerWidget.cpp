 ...
 */
    ...
    public:
         ...
         */
        explicit DockContainerWidgetPrivate(CDockContainerWidget *_public);
        ...
        CDockSplitter *newSplitter(Qt::Orientation orientation, QWidget *parent = nullptr) {
            auto *s = new CDockSplitter(orientation, parent);
...
//============================================================================
    void
    DockContainerWidgetPrivate::moveToNewSection(QWidget *Widget, CDockAreaWidget *TargetArea, DockWidgetArea area) {
        // Dropping into center means all dock widgets in the dropped floating
        // widget will become tabs of the drop area
        if (CenterDockWidgetArea == area) {
